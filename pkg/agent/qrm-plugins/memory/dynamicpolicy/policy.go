...
func (p *DynamicPolicy) removePod(podUID string, writeThroughCheckpoint bool) error {
	podResourceEntries := p.state.GetPodResourceEntries()
...
func (p *DynamicPolicy) removeContainer(podUID, containerName string, writeThroughCheckpoint bool) error {
	podResourceEntries := p.state.GetPodResourceEntries()
