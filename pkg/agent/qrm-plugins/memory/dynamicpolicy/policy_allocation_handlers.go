...
func (p *DynamicPolicy) sharedCoresAllocationHandler(ctx context.Context,
	...
	case apiconsts.PodAnnotationMemoryEnhancementNumaBindingEnable:
		return p.numaBindingAllocationHandler(ctx, req, apiconsts.PodAnnotationQoSLevelSharedCores, writeThroughCheckpoint)
	default:
		return p.allocateNUMAsWithoutNUMABindingPods(ctx, req, apiconsts.PodAnnotationQoSLevelSharedCores, writeThroughCheckpoint)
	}
}

func (p *DynamicPolicy) systemCoresAllocationHandler(_ context.Context, req *pluginapi.ResourceRequest, writeThroughCheckpoint bool) (*pluginapi.ResourceAllocationResponse, error) {
	if req == nil {
	...
	case apiconsts.PodAnnotationMemoryEnhancementNumaBindingEnable:
		...
		return p.allocateTargetNUMAs(req, apiconsts.PodAnnotationQoSLevelSystemCores, defaultSystemCoresNUMAs, writeThroughCheckpoint)
	default:
		return p.allocateTargetNUMAs(req, apiconsts.PodAnnotationQoSLevelSystemCores, p.topology.CPUDetails.NUMANodes(), writeThroughCheckpoint)
	}
}
...
func (p *DynamicPolicy) reclaimedCoresAllocationHandler(ctx context.Context,
	...
	return p.reclaimedCoresBestEffortNUMABindingAllocationHandler(ctx, req, writeThroughCheckpoint)
}
...
func (p *DynamicPolicy) dedicatedCoresAllocationHandler(ctx context.Context,
	...
	switch req.Annotations[apiconsts.PodAnnotationMemoryEnhancementNumaBinding] {
	case apiconsts.PodAnnotationMemoryEnhancementNumaBindingEnable:
		return p.numaBindingAllocationHandler(ctx, req, apiconsts.PodAnnotationQoSLevelDedicatedCores, writeThroughCheckpoint)
	default:
...
func (p *DynamicPolicy) numaBindingAllocationHandler(ctx context.Context,
	...
	if req.ContainerType == pluginapi.ContainerType_SIDECAR {
		...
		return p.numaBindingAllocationSidecarHandler(ctx, req, qosLevel, writeThroughCheckpoint)
	}
	...
	p.state.SetAllocationInfo(v1.ResourceMemory, req.PodUid, req.ContainerName, allocationInfo, writeThroughCheckpoint)
	...
	p.state.SetMachineState(machineState, writeThroughCheckpoint)
...
func (p *DynamicPolicy) reclaimedCoresBestEffortNUMABindingAllocationHandler(ctx context.Context,
	...
	if req.ContainerType == pluginapi.ContainerType_SIDECAR {
		// sidecar container admit after main container
		return p.numaBindingAllocationSidecarHandler(ctx, req, apiconsts.PodAnnotationQoSLevelReclaimedCores, writeThroughCheckpoint)
	}
...
func (p *DynamicPolicy) numaBindingAllocationSidecarHandler(_ context.Context,
	...
	p.state.SetMachineState(resourcesState, writeThroughCheckpoint)
...
func (p *DynamicPolicy) allocateNUMAsWithoutNUMABindingPods(_ context.Context,
	...
	p.state.SetAllocationInfo(v1.ResourceMemory, allocationInfo.PodUid, allocationInfo.ContainerName, allocationInfo, writeThroughCheckpoint)
	podResourceEntries := p.state.GetPodResourceEntries()
...
func (p *DynamicPolicy) allocateTargetNUMAs(req *pluginapi.ResourceRequest,
	qosLevel string, targetNUMAs machine.CPUSet, writeThroughCheckpoint bool,
) (*pluginapi.ResourceAllocationResponse, error) {
	if !pluginapi.SupportedKatalystQoSLevels.Has(qosLevel) {
		return nil, fmt.Errorf("invalid qosLevel: %s", qosLevel)
	}
